...
Route::group(['middleware' => 'auth', 'prefix' => 'admin'], function () {
    ...
    Route::get('admin/compras/{compra}/comprobante', [App\Http\Controllers\compraController::class, 'downloadComprobante'])
    ->name('compras.download-comprobante');
    ...
    // Ruta para exportar inmediatamente y forzar la descarga (no encola job)
    Route::get('/export-excel-ventas-now', [ExportExcelController::class, 'exportExcelVentasAllNow'])
        ->name('export.excel-ventas-now');
