...
class compraController extends Controller
{
    ...
    public function downloadComprobante(Compra $compra)
    {
        if (!$compra->comprobante_path) {
            abort(404);
        }

        // comprobante_path guarda 'storage/compras/nombre.pdf'
        $relative = Str::after($compra->comprobante_path, 'storage/'); // 'compras/nombre.pdf'
