...
<style>
 body{
    background: url('{{ asset('assets/img/login.png') }}') no-repeat center center fixed;
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route('login.login')}}" method="post">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            ...
                                            <a href="{{ route('panel') }}" class="btn btn-secondary ms-2">Volver</a>
                                        </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted"> Sistema de Gestion de Inventario &copy; UTS 2025 </div>
                    </div>
                </div>
            </footer>
        </div>
