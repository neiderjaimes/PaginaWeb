...
<script>
    ...
    new Chart(ventasChart, {
        ...
        data: {
            ...
            datasets: [{
                label: "Ventas",
                lineTension: 0.3,
                backgroundColor: "rgba(2, 217, 145, 0.2)",
                borderColor: "rgba(2, 217, 145, 1)",
                pointRadius: 5,
                pointBackgroundColor: "rgba(2, 217, 145, 1)",
                pointBorderColor: "rgba(255,255,255,0.8)",
                pointHoverRadius: 5,
                pointHoverBackgroundColor: "rgba(2, 217, 145, 1)",
                pointHitRadius: 50,
                pointBorderWidth: 2,
                data: montos,
            }],
    ...
    new Chart(productosChart, {
        ...
        data: {
            ...
            datasets: [{
                label: 'stock',
                backgroundColor: "rgba(51, 148, 228, 1)",
                borderColor: "#fff",
                data: stock,
                borderWidth: 2,
